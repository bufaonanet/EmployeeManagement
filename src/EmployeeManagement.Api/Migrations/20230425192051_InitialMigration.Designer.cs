...
namespace EmployeeManagement.Api.Migrations
{
    ...
    [Migration("20230425192051_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeManagement.Api.DataAccess.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EmployeeManagement.Api.DataAccess.Entities.ExternalEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EmployeeManagement.Api.DataAccess.Entities.InternalEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CourseInternalEmployee", b =>
                {
                    b.HasOne("EmployeeManagement.Api.DataAccess.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("AttendedCoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmployeeManagement.Api.DataAccess.Entities.InternalEmployee", null)
                        .WithMany()
